...
public class CreateBuildingValidatorTests
{
    ...
    private readonly IValidator<CreateBuildingRequest> _validator;

    public CreateBuildingValidatorTests()
    {
        _validator = new CreateBuildingValidator(_riskIndicatorRepository.Object, _cityRepository.Object);
    }
    ...
    [Fact]
    public async Task ValidateAsync_MissingConstructionYear_ShouldHaveError()
    {
        var req = ValidRequest();
        req.ConstructionYear = 0;
        ...
        result.ShouldHaveValidationErrorFor(b => b.ConstructionYear)
            .WithErrorMessage("ConstructionYear is required.");
    }
    ...
    private CreateBuildingRequest ValidRequest() => new CreateBuildingRequest
    {
        Address = "Some Street",
        CityId = Guid.NewGuid(),
