...
public class CreateBrokerValidatorTests
{
    ...
    private readonly IValidator<CreateBrokerRequest> _validator = new CreateBrokerValidator();
    ...
    public async Task ValidateAsync_InvalidCodeLength_ShouldHaveError(string code)
    {
        ...
        result.ShouldHaveValidationErrorFor(b => b.Code)
            .WithErrorMessage("Broker Code is required and must be between 8 and 128 characters.");
    }
    ...
    public async Task ValidateAsync_InvalidEmail_ShouldHaveError(string email)
    {
        ...
        result.ShouldHaveValidationErrorFor(b => b.Email)
            .WithErrorMessage("Email is required and must be a valid email address.");
    }
    ...
    private CreateBrokerRequest ValidRequest() => new CreateBrokerRequest
    {
        Code = "BRK-RO-001",
